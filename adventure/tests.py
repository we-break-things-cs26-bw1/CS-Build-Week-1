import random
#Inspiration from http://www.roguebasin.com/index.php?title=A_Simple_Dungeon_Generator_for_Python_2_or_3&action=edit
# Merchant to go here
...
class Generator():
    ...
    def room_overlapping(self, room, room_list):
        #room overlapping can be turned off default is set to off
        x = room[0]
        y = room[1]
        w = room[2]
        h = room[3]
...
#
# (1) remove the unesssary information
# (2) make more rectangular and even
